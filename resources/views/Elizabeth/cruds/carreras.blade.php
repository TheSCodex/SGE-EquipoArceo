...
@endsection
@section('contenido')
    <div class="text-xs md:text-base md:px-[7%]  flex justify-center  w-full">
      <div class="text-xs md:text-base md:w-11/12 lg:w-3/3 flex justify-between  border-b border-[#E5E5E5] py-[1%]">
<div class="text-xs md:text-base flex justify-between mb-3">
    <h1 class=" md:text-2xl font-bold">Carreras y Divisiones</h1>
</div>
<div class="text-xs md:text-base flex flex-wrap justify-around mb-2 items-center w-[36vw]">
  <div>
