...
@section('contenido')
            ...
            <div class="sm:mt-[2%] w-full flex items-center justify-between">
                <table class="w-full text-center">
                    ...
                    <tr>
                        ...
                        <td class="font-roboto font-bold max-sm:hidden py-[2.5%]">{{ $usuario['apellido'] }}</td>
                        <td class="font-roboto font-bold max-sm:hidden py-[2.5%]">{{ $usuario['rol'] }}</td>
                        <td class="font-roboto font-bold max-sm:hidden py-[2.5%]">{{ $usuario['nomina'] }}</td>
                        <td class="font-roboto font-bold max-sm:hidden py-[2.5%]">{{ $usuario['especialidad'] }}</td>
    ...
    <div id="myModal{{ $index }}" class="myModal hidden fixed inset-0 z-50 overflow-auto bg-black bg-opacity-50">
        <div class="modal my-[4%] p-[3%]  bg-white  w-[74vw] mx-auto h-[85vh] rounded-lg shadow-lg ">
            <h2 class="text-2xl  font-extrabold text-center mb-3">Detalles de la empresa</h2>
            ...
            <div class="border-b-2 border-t-2 items-center flex flex-row justify-between">
                ...
                <p class="font-roboto font-bold py-[2.5%]">{{ $usuario['apellido'] }}</p>
            </div>
            <div class="border-b-2 border-t-2 items-center flex flex-row justify-between">
