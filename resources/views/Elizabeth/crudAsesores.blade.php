...
<main class="min-h-screen h-full flex flex-col">
    <div class="border-b border-gray-200 mt-5 pb-2 mx-auto w-11/12 md:flex md:items-center md:justify-between">
        ...
        <div class="flex justify-between md:hidden mt-2 mx-auto">
            ...
            <a href="/panel-asesores-create" class="bg-green text-lg py-2 px-4 rounded-md text-white ml-2">Agregar nueva empresa
                </a>
        </div>
    </div>
            ...
            <div class="grid md:grid-cols-2 gap-4 w-full">
                @foreach ($users as $user)
                    <div class="bg-white rounded-lg shadow-md p-4 drop-shadow-2xl">
                        ...
                        <p class="text-sm text-gray-500">Fecha de registro: {{ $user['grado_academico'] }}</p>
                        <p class="text-sm text-gray-500">dirección: {{ $user['departamento'] }}</p>
