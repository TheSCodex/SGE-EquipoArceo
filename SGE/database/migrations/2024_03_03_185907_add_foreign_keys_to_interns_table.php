...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('interns', function (Blueprint $table) {
            ...
            $table->foreign(['academic_advisor_id'], 'interns_ibfk_2')->references(['id'])->on('users')->onUpdate('no action')->onDelete('no action');
            ...
            $table->foreign(['student_status_id'], 'interns_ibfk_5')->references(['id'])->on('student_status')->onUpdate('no action')->onDelete('no action');
        });
    }
