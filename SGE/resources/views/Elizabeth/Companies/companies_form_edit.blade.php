...
@section('contenido')
    <div class="w-full py-2 sm:h-screen flex justify-center items-center max-sm:px-10 bg-white">
        ...
        <form action="{{ route('panel-companies.update', $company->id) }}" method="POST"
            class="flex flex-col font-montserrat mx-30 space-y-5 lg:w-[80vw] sm:w-[90vw]">
            ...
            <div class="w-full gap-4 sm:grid grid-cols-2 space-y-2">
                ...
                <div class="w-full space-y-2">
                    ...
                    <input type="number" name="phone" value="{{ $company->phone }}"
                ...
                <div class="w-full space-y-2">
                    ...
                    <input type="date" name="registration_date" value="{{ $company->registration_date }}"
                ...
                <div class="w-full space-y-2">
                    ...
                    <input type="text" name="rfc" value="{{ $company->rfc }}"
                ...
                <div class="form-group">
                    ...
                    <select class="text-sm rounded-md border-lightGray border-2 px-4 py-3 w-full" id="business_sector_id"
                        name="business_sector_id">
                        <option value="" disabled>Seleccionar giro empresarial</option>
            ...
            <div class="flex justify-center items-center">
                <button type="submit" class="p-2 bg-primaryColor w-full lg:w-[30vw]  rounded-md text-white">Editar
                    empresa</button>
