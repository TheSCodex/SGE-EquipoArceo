...
@section('contenido')
<div class="w-full py-2 md:px-[7em] md:mt-[2em] sm:h-screen   justify-center flex bg-white">
    <div class="flex flex-col font-montserrat space-y-5 w-full mt-4 md:mt-0 md:w-full ">
        <div class="w-full h-fit flex  md:justify-start">
            <h1 class="text-xl md:text-3xl text-center max-w-96 truncate font-bold">Detalles de {{$companies->name}}</h1>
        </div>
        <div class="w-full flex flex-col space-y-2 ">
            <div class="flex md:flex-row flex-col items-center md:items-start justify-around">
                <div class="space-y-2">
                    ...
                    <div class=" space-y-2">
                        ...
                        <div class="text-sm rounded-md border-lightGray border-2 px-4 py-3 w-[20em] md:w-[35em]">
                            <p class=" max-w-[20em] truncate">{{$companies->address}}</p> 
                        </div>
                    </div>
                </div>
                <div class=" space-y-2">
            ...
            <a class="p-2 self-center bg-primaryColor w-[17.7rem] md:w-[30rem] rounded-md   text-white hover:bg-darkgreen text-center" href="/panel-companies">Regresar al panel de empresas</a>
