    ...
    <div class="w-full py-2 md:px-[7em] md:mt-[2em] sm:h-screen   justify-center flex bg-white">
        <div class="flex flex-col font-montserrat space-y-5 w-full mt-4 md:mt-0 md:w-full ">
            <div class="w-full h-fit flex  md:justify-start">
                <h1 class="text-xl md:text-3xl text-center max-w-96 truncate font-bold">Detalles de {{ $companies->name }}
                </h1>
            </div>
                ...
                <div class="  flex-row flex ">
                    ...
                    <div class=" space-y-2">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="text-sm  rounded-md border-lightGray border-2 px-4 py-3 w-[30em] md:w-[35em]">
