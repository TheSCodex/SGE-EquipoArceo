...
@section('contenido')
    ...
    <section class="flex flex-col justify-center items-center bg-[#F3F5F9] min-h-full flex-grow">
        ...
        <div class="w-[91w] sm:w-[85vw] sm:min-h-[78vh] items-center flex flex-wrap sm:justify-between flex-grow bg-black">
    ...
    <div class="w-full min-h-[92.5%] bg-white px-[2%] py-[.5%] rounded-sm font-bold flex flex-wrap items-center flex-col">
                ...
                <div class="w-full sm:min-h-[71vh] bg-white px-[2%] py-[.5%] rounded-sm font-bold flex flex-wrap justify-center items-center flex-col">
            ...
            <div class="sm:w-[31%] h-[82%] sm:h-full flex flex-wrap sm:flex-col justify-between mt-[1%] sm:mt-0 self-center gap-[1vh]">
