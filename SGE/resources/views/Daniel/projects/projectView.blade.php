...
@section('contenido')
    ...
    <section class="flex flex-col justify-center items-center bg-[#F3F5F9]">
        ...
        <div class="w-[91w] sm:w-[85vw] h-[80vh] flex flex-wrap sm:justify-between">
            ...
            <div class="w-full sm:w-[68%] h-[25%] sm:h-full flex flex-wrap flex-col justify-between">
                <div class="w-full bg-white px-[2%] py-[.5%] flex-col rounded-sm font-semibold sm:font-bold ">
            ...
            <div class="sm:w-[30%] h-[82%] sm:h-full flex flex-wrap sm:flex-col justify-between mt-[1%] sm:my-0">
                <div class="w-full bg-white px-[2%] py-[1.6%] rounded-sm font-semibold sm:font-bold text-sm mb-[.5%] sm:mb-0">
