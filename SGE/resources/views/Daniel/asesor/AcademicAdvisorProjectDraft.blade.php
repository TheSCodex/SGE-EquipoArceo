                ...
                <div
                    ...
                    <div class="w-[80%] flex flex-wrap items-center h-full gap-[10%]">
                        ...
                        <div class="w-[70%] flex justify-between flex-wrap flex-row-reverse">
                            ...
                            @else
                                <p>Este proyecto cuenta con <span
                                        class="text-primaryColor border-b-[.4vh] border-b-primaryColor px-1 mb-1 font-bold py-0.5">{{ $project->like }}
                                        @if ($project->like == 1)
                                        voto</span></p>
                                        @else
                                        votos</span></p>
                            ...
                            @else
                                <form method="POST" id="voteForm"
                                    ...
                                    <button type="button" onclick="confirmVote()"
                                        class="bg-[#02AB82] text-white rounded-lg px-[1vw] mt-2 self-end  mr-[-2vw]">Votar</button>
                                </form>
                            @endif
                        </div>
                    </div>
