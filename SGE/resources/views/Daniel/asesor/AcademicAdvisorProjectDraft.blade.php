...
@section('contenido')
    <div class="flex flex-col justify-center items-center bg-[#F3F5F9]">
        <div class="sm:p-8 text-left w-[90%]">
            <h1 class="text-2xl font-bold text-green-500 mb-[4%] sm:mb-[3%] border-b py-[1%] px-[1%] border-slate-700  ">Mi
                Anteproyecto </h1>
            <div class="w-[91w] sm:w-[85vw] h-[80vh] flex flex-wrap sm:justify-between">
                ...
                <div class="w-full sm:w-[68%] h-fit  sm:h-full flex flex-wrap flex-col justify-between">
                    ...
                    <div
                        class="w-full sm:h-[92.5%] bg-white px-[2%] py-[.5%] rounded-sm font-bold flex flex-wrap items-center flex-col">
                    ...
                    <div
                        ...
                        <div class="w-[80%] flex flex-wrap items-center h-full gap-[10%]">
                            ...
                            <div class="w-[70%] flex justify-between flex-wrap flex-row-reverse">
                                ...
                                <button
                                    class="bg-[#02AB82] absolute text-white rounded-lg px-[1vw] self-end mb-[-1vh] mr-[-2vw]">Votar</button>
                            </div>
                        </div>
                    </div>
