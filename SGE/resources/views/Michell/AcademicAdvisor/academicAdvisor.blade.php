    ...
    <section class="my-[2cm] mx-[2cm] max-md:mx-0 max-md:w-full">
        <div class="bg-white rounded-md py-1 flex justify-between items-center mb-10 border-b-2  max-md:w-full">
            ...
            <div class="w-[50%] flex justify-evenly max-md:hidden">
                <input placeholder="Buscador" type="search" name="d" id="searchDesktop" class="w-[50%] placeholder:text-green placeholder:px-3 rounded-md mb-4 border-2 border-green focus:outline-none px-3">
    ...
    <section class="my-[2cm] mx-[2cm] max-md:mx-0 ">
        <table class="my-[2cm] mx-[2cm] min-w-full divide-y divide-gray-200 max-md:mx-0 max-md:w-full max-md:hidden" id="dataTable">
            <thead>
                <tr>
