...
@section('contenido')
                ...
                <div class="mx-10 flex flex-col h-full justify-between">
                    <div>
                        <div class="flex items-center space-x-8 mt-4">
                            ...
                            <a href="observaciones" class="bg-primaryColor rounded-md text-white py-1 w-[28%]">Ampliar observación</a>
                        </div>
    ...
    <div class="bg-[#6FCBD8] text-white rounded-md flex flex-col justify-evenly items-centermx-4 p-4">
        ...
        <h4 class="mt-4 mb-12">Kevin, tu propuesta es bastante atractiva sin embargo, necesito que clarifiques un poco más acerca 
            de la metodología de desarrollo que estarás realizando y los beneficios esperados para la empresa.
             ¿Crees que puedas tener esta información lista en nuestra siguiente reunión? Debo aprobar tu propuesta pronto para que pases lo antes a revisión.</h4>
 <a href="#"
