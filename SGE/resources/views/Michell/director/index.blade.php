...
@section('contenido')
<div class="bg-[#F3F5F9] flex h-screen gap-2 p-4">
    <article class="grid grid-cols-3 gap-x-3 font-['Kanit'] h-full">
        <section class="col-span-2 flex flex-col gap-3 flex-1">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-3 mx-auto">
            ...
            <div class="bg-white rounded-md py-14 px-10">
                ...
                <div class="grid grid-cols-4">
                    <div class="col-span-3 px-3">
                        ...
                        <p class="text-gray-500">Tu introducción es demasiado ambigua y redundante, por favor reestructurala o hazla de nuevo</p>
                    </div>
                    <div class="flex items-center justify-center">
