    ...
    <form action="{{url('primer-cambio-contra')}}" method="POST">
      ...
      <div class="mb-6">
        ...
        <div class="relative">
            ...
            <div class="absolute inset-y-0 right-0 pr-3 flex items-center">
                <img src="/img/visible.png" id="togglePasswordVisibility" class="w-6 cursor-pointer" alt="">
            </div>
        </div>
        @error('new_password')
      ...
      <div class="mb-6">
        ...
        <div class="relative">
            ...
            <div class="absolute inset-y-0 right-0 pr-3 flex items-center">
                <img src="/img/visible.png" id="toggleConfirmPasswordVisibility" class="w-6 cursor-pointer" alt="">
            </div>
        </div>
